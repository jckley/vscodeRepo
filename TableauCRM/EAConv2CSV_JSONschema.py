...
# EXECUTE = python EAConv2CSV_JSONschema.py  inputjsonfile inputcsvfile N
...
for x in range(1, in_nrocsvs + 1):
    ...
    input_file = (
        "/Users/juancarloskleylein/Downloads/AWS_CSV/" + aux
    )  # toma los input CSV de Downloads/AWS_CSV/
    print(input_file)
