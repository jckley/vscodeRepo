...
# Then adds N headerless CSV File comprising the above mentiones fields

# EXECUTE = python EARecipeConvert2CSV.py  inputjsonfile inputcsvfile N       
# (inputcsvfile = nombre del csv sin indice - sin el "_n" y sin file format extension ; inputjsonfile = idem sin extension, "N" ultimo numero de archivo a concatenar 1...N)
...
for x in range(1, in_nrocsvs+1):
    ...
    with open(input_file) as inputcsv:
        ...
        while line:
            ...
            csvfile.write(line)   #escribe la linea modificada en el csvfile = open(output_file,'w')
            count += 1
